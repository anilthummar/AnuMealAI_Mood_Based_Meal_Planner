...
class AppConfig {
  ...
  static const String aiApiKey = String.fromEnvironment('AI_API_KEY', defaultValue: '');

  static bool get isConfigured => aiApiKey.isNotEmpty || aiApiBaseUrl.isNotEmpty;

  static const String appName = 'AnuMealAI';
  static const String appTagline = 'Your mood. Your ingredients. Your perfect meal.';
}
